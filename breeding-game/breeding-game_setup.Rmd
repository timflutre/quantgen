...
But in the generative model, maybe it should be included when simulating the initial phenotypes of the collection?
...
For each individual initially given to the players, save its haplotypes into a file (slow) and save it into the table:
