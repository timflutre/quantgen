...
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('cost.plot', '", 50, "')") # in Mendels
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('cost.cross', '", 1/2, "')") # compare to one plot
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
...
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('min.trait1', '", 1.03, "')") # compare to the controls
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('min.trait2', '", 14, "')") # idem
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('nb.years.per.ctl', '", nb.years.per.ctl, "')") # additional phenos of controls
res <- dbGetQuery(conn=db, query)
query <- paste0("INSERT INTO ", tbl, " VALUES",
                " ('nb.plots.per.ctl', '", nb.plots.per.ctl, "')") # idem
res <- dbGetQuery(conn=db, query)
```
