% Copyright (C) 2015,2024,2026 Timothee Flutre
...
\newcommand{\etal}{\textit{et al.}} % useful when citing a paper
\newcommand{\E}{\text{E}} % useful when writing an expectation
...
% \titlegraphic{
%   \begin{tabular}{@{}c@{}}{\includegraphics[width=1.5cm]{logo1}}\end{tabular}
%   \hspace{1cm}
%     \begin{tabular}{@{}c@{}}{\includegraphics[width=1.5cm]{logo2}}\end{tabular}
%   \hspace{1cm}
%   \begin{tabular}{@{}c@{}}{\includegraphics[width=1.5cm]{logo3}}\end{tabular}
%   \hspace{1cm}
%   \begin{tabular}{@{}c@{}}{\includegraphics[width=1.5cm]{logo4}}\end{tabular}
% }
